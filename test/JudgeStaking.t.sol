...
function testEarlyWithdraw()public{
    ...
    uint256 accJudgePerShareAFter2000Blocks = Math.mulDiv(2000, Math.mulDiv(1_000_000 * 10 ** uint256(decimals), 1e18, 648_000),  user1Stake1StakeWeight);
...
function testHowMuchUser1ReceivesAfterEmergencyWithdrawal()public{
    ...
    uint256 user1Stake1RewardsExpected = Math.mulDiv(Math.mulDiv(4e22, 10, 360), accJudgePerShareAFter80_000Blocks, 1e18) - 0;
    uint256 user1Stake1BonusRewardsExpected = Math.mulDiv(Math.mulDiv(4e22, 10, 360), accBonusJudgePerShareAfter80_000Blocks, 1e18) - 0;
    ...
    console.log("user1Stake1BonusRewardsExpected", user1Stake1BonusRewardsExpected);
     uint256 user1Stake2RewardsExpected = Math.mulDiv(4e22, accJudgePerShareAFter80_000Blocks, 1e18) - Math.mulDiv(4e22, accJudgePerShareAFter3000Blocks, 1e18);
    uint256 user1Stake2BonusRewardsExpected = Math.mulDiv(4e22, accBonusJudgePerShareAfter80_000Blocks, 1e18) - Math.mulDiv(4e22, accBonusJudgePerShareAfter3000Blocks, 1e18);
